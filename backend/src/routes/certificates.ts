...
router.get(
  "/data-fields",
  authenticateToken,
  certificateController.getAvailableDataFields
);
...
router.put(
  ...
  authenticateToken,
  certificateController.updatePlaceholderMapping
);
router.delete(
...
router.get(
  ...
  authenticateToken,
  certificateController.getEligibleParticipants
);
router.post(
...
router.post(
  ...
  authenticateToken,
  certificateController.emailCertificates
);
...
); // Fixed: removed 's' to match frontend
