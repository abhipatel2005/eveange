...
export async function sendEmailViaGmailAPI(userEmail, accessToken, refreshToken, to, subject, htmlContent, attachment) {
    try {
        ...
        if (attachment) {
            console.log(`📎 Attachment included: ${attachment.filename} (${attachment.content.length} bytes)`);
        }
    }
    catch (error) {
