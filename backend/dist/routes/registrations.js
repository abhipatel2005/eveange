...
router.get("/events/:eventId/registration-status", RegistrationController.checkRegistrationStatus);
...
router.put("/:registrationId/cancel", RegistrationController.cancelRegistration);
