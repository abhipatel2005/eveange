...
import { authRateLimit, emailRateLimit, registrationRateLimit, } from "../middleware/rateLimiting.js";
const router = Router();
...
router.get("/debug/email-verifications", AuthController.debugEmailVerifications);
// POST /api/auth/resend-verification - With rate limiting
router.post("/resend-verification", emailRateLimit, AuthController.resendVerification);
